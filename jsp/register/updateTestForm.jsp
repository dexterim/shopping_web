...
<div class="container">
	<div class="page-header">
	  <h1>member테이블에 레코드 수정 <small>2cban</small></h1>
	</div>
	<form class="form-horizontal" method="post" action="updateTestPro.jsp">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" name="name" placeholder="이름 입력" maxlength="10">
			</div>
		</div>
		<div class="form-group">
			<div class="col-sm-5 col-sm-offset-2">
				<input type="submit" class="btn btn-warning btn-block" value="정보 변경 완료">
			</div>
			<div class="col-sm-5">
				<a href="/cban/_final_test/jsp/include.jsp" class="btn btn-success btn-block">이전 페이지로</a>
			</div>
